...
Bölüm 1 de bahsettiğimiz RDMS (İlişkisel Veri Tabanı Yönetim Sistemi)
  ...
  --- BURADA TUM SATIRLARI CEKİYORUZ--
  SELECT*FROM SALES


  -- BURADA TOPLAM SATISI SATIR SAYISINI MAX VE MIN SATISI VE ORTALAMA SATISI
  --KOCAELİ SUBESİ İÇİN ÇEKİYORUZ --
  ...
  --BURDA TOPLAM SATISI 50 BINDEN FAZLA OLAN SUBELERI CEKİYORUZ--
  -- VE TOPLAM SATISA GORE AZALAN SIRALAMA YAPIYORUZ--
...
-- BURADA ANKARA SUBESİ'NDE BELİRLİ BİR TARİHTEKİ SATISI ÇEKİYORUZ--
-- VE TARİHE GÖRE SIRALAMA YAPIYORUZ--
